...
public interface SymbolRepository extends JpaRepository<SymbolEntity, String>, QueryDslPredicateExecutor<SymbolEntity> {
	...
	List<SymbolEntity> findAllByCurrencyCodeIsNullOrderByCode();

	List<SymbolEntity> findAllByCurrencyCode(String code);

	List<SymbolEntity> findAllByCurrencyCodeInOrderByCode(List<String> codes);

	@Override
	List<SymbolEntity> findAll(Predicate predicate);
}