...
public interface HistoricalRateRepository extends HistoricalRateRepositoryCustom, JpaRepository<HistoricalRate, Long>, QueryDslPredicateExecutor<HistoricalRate> {
	...
	List<DateValue> findDateValues(@Param("fromcur") String fromcur, @Param("tocur") String tocur, @Param("start") Date startDate, @Param("end") Date endDate);
	...
	List<DateValue> findHourlyValues(@Param("fromcur") String fromcur, @Param("tocur") String tocur, @Param("start") Date startDate, @Param("end") Date endDate);
	...
	List<DateValue> findDailyValues(@Param("fromcur") String fromcur, @Param("tocur") String tocur, @Param("start") Date startDate, @Param("end") Date endDate);
	...
	List<DateValue> findWeeklyValues(@Param("fromcur") String fromcur, @Param("tocur") String tocur, @Param("start") Date startDate, @Param("end") Date endDate);
